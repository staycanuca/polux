...
""" Copyright (c) 2017 Mario Bălănică
    ...
    Classes:
    download_tools() -> Contains a downloader, an extraction function and a remove function.
    ...
    url_isup(url, headers=None) -> Check if URL address is up. Returns True or False.
