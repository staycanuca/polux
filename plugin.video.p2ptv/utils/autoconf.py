...
""" Copyright (c) 2017 Mario Bălănică
    ...
    This file contains a single function that will run at first addon boot in order to configure Acestream and SopCast for used platform.
    The platform will be automatically detected and the necessary files will be downloaded and extracted to the userdata.
    This function will run if and only the setting "Repeat configuration on the next run" is enabled.
    
    Functions:
    check_for_updates() -> Look for module updates and force download them.
    firstconf() -> Configuration function, detects the platform, saves to settings, starts dependencies configuration.
...
from webutils import download_tools,get_page_source
from utilities import *

""" Platform dependent files downloaded during the addon configuration"""
trunkfolder = "https://gitlab.com/mariobalanica/p2ptv-dependencies/raw/master"
...
def check_for_updates():
    ...
    if version_source:
        ...
        if acestream_update and sopcast_update: settings.setSetting('last_version_check',value=addonver)
        return
...
def first_conf():
    ...
    if xbmc.getCondVisibility('system.platform.linux') and not xbmc.getCondVisibility('system.platform.Android'):
        if "arm" in os.uname()[4]:
            messageok(translate(30000),translate(30128),translate(30129))
            ...
            if os.uname()[4] == "x86_64":
                if re.search(os.uname()[1],"openelec",re.IGNORECASE):
                    ...
                    YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30074))
                    if YNDialog:
                        settings.setSetting('openelecx86_64',value='true')
            elif os.uname()[4] == "i386" or os.uname()[4] == "i686":
                if re.search(os.uname()[1],"openelec",re.IGNORECASE):
                    ...
                    YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30075))
                    if YNDialog:
                        settings.setSetting('openeleci386',value='true')
            check_for_updates()
        ...
        messageok(translate(30000), translate(30186))
        #sys.exit(0)
        check_for_updates()
    ...
    if xbmc.getCondVisibility('system.platform.linux') and not xbmc.getCondVisibility('system.platform.Android'):
        ...
        if "arm" in os.uname()[4]:
            ...
            if settings.getSetting('rpi2') == "true":
                ...
                if tarfile.is_tarfile(SPSC_KIT):
                    path_libraries = os.path.join(addonprofile,"sopcast")
            ...
            if settings.getSetting('openelecx86_64') == "true":
                ...
                if tarfile.is_tarfile(SPSC_KIT):
                    download_tools().extract(SPSC_KIT,addonprofile)
                    xbmc.sleep(500)
                    download_tools().remove(SPSC_KIT)
                if latest_version: settings.setSetting('sopcast_version',value=latest_version)
                return
        ...
        if generic == True:
            ...
            for fileloc in files:
                binary_path = os.path.join(path_libraries,fileloc)
        ...
        if is_admin == False:
            messageok(translate(30000),translate(30077),translate(30078))
        else:
            ...
            xbmc.sleep(1000)
            ret = messagepg.create(translate(30000),translate(30000))
            messagepg.update(0,translate(30184),"  ")
            xbmc.sleep(1000)
            import _winreg
            ...
            try:
                ...
                messagepg.update(10,translate(30079),translate(30080))
            except:
                sopcast_executable = ""
                messageok(translate(30000),translate(30081),translate(30082))
            if not sopcast_executable: pass
            else:
                xbmc.sleep(1000)
                messagepg.update(20,translate(30083),"  ")
                xbmc.sleep(1000)
                ...
                for i in range(1024):
                    try:
                        ...
                        pass
                if not users:
                    messageok(translate(30000),translate(30084))
                else:
                    messagepg.update(30,translate(30085),translate(30080))
                    xbmc.sleep(200)
                    messagepg.update(30,translate(30086),"   ")
                    xbmc.sleep(1000)
                    ...
                    ret = messagepg.create(translate(30000),translate(30000))
                    xbmc.sleep(200)
                    messagepg.update(35,translate(30088),"  ")
                    xbmc.sleep(1000)
                    ...
                    if servicecreator == False:
                        messageok(translate(30000),translate(30089))
                    else:
                        messagepg.update(40,translate(30088),translate(30080))
                        xbmc.sleep(1000)
                        messagepg.update(45,translate(30090),"  ")
                        xbmc.sleep(1000)
                        ...
                        try:
                            ...
                            messagepg.update(50,translate(30090), translate(30080))
                            regedit = True
                        except:
                            messageok(translate(30000),translate(30091))
                            regedit = False
                        if regedit == False: pass
                        else:
                            xbmc.sleep(1000)
                            messagepg.update(50,translate(30092), "   ")
                            ...
                            if len(lines) != 1: messageok(translate(30000),translate(30093))
                            else:
                                line_arr = []
                                for user in users:
                                    line_arr.append('(A;;RPWPCR;;;' + user + ')')
                                line_add = ''
                                for line in line_arr:
                                    line_add += line
                                print("line piece to add: " + line_add)
                                line_final = lines[0].replace("S:(",line_add + "S:(")
                                print("Final line: " + line_final)
                                permissions = False
                                xbmc.sleep(500)
                                messagepg.update(60,translate(30092), translate(30080))
                                xbmc.sleep(500)
                                messagepg.update(60,translate(30094), "   ")
                                cmd = ['sc','sdset','sopcastp2p',line_final]
                                proc = subprocess.Popen(cmd,stdout=subprocess.PIPE,shell=True)
                                for line in proc.stdout:
                                    print(line.rstrip())
                                    permissions = True
                                if permissions == False: messageok(translate(30000),translate(30095))
                                else:
                                    messagepg.update(70,translate(30094), translate(30080))
                                    xbmc.sleep(1000)
                                    messagepg.update(70,translate(30096), "   ")
                                    print("Trying to set sopcastp2p service regedit permissions...")
                                    download_tools().Downloader(srvany_permissions,os.path.join(addonprofile,"sopcastp2p-permissions.txt"),translate(30097),translate(30000))
                                    xbmc.sleep(500)
                                    ret = messagepg.create(translate(30000),translate(30000))
                                    xbmc.sleep(500)
                                    messagepg.update(80,translate(30098), "   ")
                                    xbmc.sleep(1000)
                                    cmd = ['regini',os.path.join(addonprofile,"sopcastp2p-permissions.txt")]
                                    proc = subprocess.Popen(cmd,stdout=subprocess.PIPE,shell=True)
                                    for line in proc.stdout:
                                        print(line.rstrip())
                                    messagepg.update(90,translate(30098), translate(30098))
                                    messagepg.update(100,translate(30099), "   ")
                                    xbmc.sleep(2000)
                                    messagepg.close()
                                    if latest_version: settings.setSetting('sopcast_version',value=latest_version)
                                    return
        ...
        if available == True:
            ...
            if tarfile.is_tarfile(MAC_KIT):
                path_libraries = os.path.join(addonprofile)
                download_tools().extract(MAC_KIT,addonprofile)
                download_tools().remove(MAC_KIT)
                sp_sc_auth = os.path.join(addonprofile,"sopcast","sp-sc-auth")
            ...
            messageok(translate(30000),translate(30100))
            return
        ...
        if found == True:
            ...
            if os.path.exists(xbmc_data_path) and uid == os.stat(xbmc_data_path).st_uid:
                android_binary_dir = os.path.join(xbmc_data_path, "files", "plugin.video.p2ptv")
                ...
                YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30101),translate(30103))
                if not YNDialog:
                    settings.setSetting('external-sopcast',value='1')
                    sopcast_installed = True
                    messageok(translate(30000),translate(30099))
                else:
                    messageok(translate(30000),translate(30104))
                    if os.path.exists(os.path.join("sdcard","Download")):
                        dirFolder = os.path.join("sdcard","Download")
                        sopfile = os.path.join("sdcard","Download",sopcast_apk.split("/")[-1])
                    else:
                        dialog = xbmcgui.Dialog()
                        dirFolder = dialog.browse(int(0), translate(30105), 'videos')
                        sopfile = os.path.join(dirFolder,sopcast_apk.split("/")[-1])
                    download_tools().Downloader(sopcast_apk,sopfile,translate(30106),translate(30000))
                    if tarfile.is_tarfile(sopfile):
                        download_tools().extract(sopfile,dirFolder)
                        download_tools().remove(sopfile)
                    messageok(translate(30000),translate(30107),dirFolder,translate(30108))
                    sopcast_installed = True
            ...
            messageok(translate(30000),translate(30109))
            return
    ...
    if xbmc.getCondVisibility('system.platform.linux') and not xbmc.getCondVisibility('system.platform.Android'):
        ...
        if "arm" in os.uname()[4]:
            ...
            if settings.getSetting('rpi2') == "true":
                ...
                binary_path = os.path.join(addonprofile,"acestream","chroot")
                st = os.stat(binary_path)
                import stat
                os.chmod(binary_path, st.st_mode | stat.S_IEXEC)
            ...
            if settings.getSetting('openelecx86_64') == "true":
                ...
                if tarfile.is_tarfile(ACE_KIT):
                    download_tools().extract(ACE_KIT,addonprofile)
                    xbmc.sleep(500)
                    download_tools().remove(ACE_KIT)
                if latest_version: settings.setSetting('acestream_version',value=latest_version)
                return
        ...
        print("Detected OS: Windows")
        if not os.path.exists(addonprofile): xbmcvfs.mkdir(addonprofile)
        ...
        if os.path.exists(os.path.join(addonprofile,"acestream")):
            shutil.rmtree(os.path.join(addonprofile,"acestream"))
        if os.path.exists(os.path.join(addonprofile,"player")):
            shutil.rmtree(os.path.join(addonprofile,"player"))
        if tarfile.is_tarfile(SPSC_KIT):
            path_libraries = os.path.join(addonprofile)
            download_tools().extract(SPSC_KIT,path_libraries)
            download_tools().remove(SPSC_KIT)
        ...
        if found == True:
            ...
            if "arm" in os.uname()[4]:
                acebundle = os.path.join(addonprofile,android_aceengine_arm.split("/")[-1])
                download_tools().Downloader(android_aceengine_arm,acebundle,translate(30111),translate(30000))
            else:
                acebundle = os.path.join(addonprofile,android_aceengine_x86.split("/")[-1])
                download_tools().Downloader(android_aceengine_x86,acebundle,translate(30111),translate(30000))
            if tarfile.is_tarfile(acebundle):
                download_tools().extract(acebundle,addonprofile)
                download_tools().remove(acebundle)
            orgacestreamenginefolder = os.path.join(addonprofile,"org.acestream.engine")
            xbmc_data_path = os.path.join("/data", "data", app_id)
            if os.path.exists(xbmc_data_path) and uid == os.stat(xbmc_data_path).st_uid:
                android_binary_dir = os.path.join(xbmc_data_path, "files", "plugin.video.p2ptv")
            ...
            YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30112),translate(30113))
            if not YNDialog:
                settings.setSetting('engine_app','0')
            else:
                messageok(translate(30000),translate(30114),translate(30115),translate(30116))
                if os.path.exists(os.path.join("sdcard","Download")):
                    dirFolder = os.path.join("sdcard","Download")
                    ...
                    dialog = xbmcgui.Dialog()
                    dirFolder = dialog.browse(int(0), translate(30105), 'myprograms')
                    if "arm" in os.uname()[4]: acefile = os.path.join(dirFolder,acestreamengine_apk_arm.split("/")[-1])
                    else: acefile = os.path.join(dirFolder,acestreamengine_apk_x86.split("/")[-1])
                ...
                if tarfile.is_tarfile(acefile):
                    download_tools().extract(acefile,dirFolder)
                    download_tools().remove(acefile)
                xbmc.sleep(2000)
                messageok(translate(30000),translate(30118),dirFolder,translate(30108))
                messageok(translate(30000),translate(30119),translate(30120),translate(30121))
                settings.setSetting('engine_app','1')
            YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30122),translate(30123))
            if YNDialog:
                if os.path.exists(os.path.join("sdcard","Download")):
                    dirFolder = os.path.join("sdcard","Download")
                ...
                if tarfile.is_tarfile(acefile):
                    ...
                    download_tools().remove(acefile)
                xbmc.sleep(2000)
                messageok(translate(30000),translate(30125),dirFolder,translate(30108))
                YNDialog= xbmcgui.Dialog().yesno(translate(30000), translate(30126))
                if YNDialog:
                    settings.setSetting('engine_app','2')
            if latest_version: settings.setSetting('acestream_version',value=latest_version)
            messageok(translate(30000),translate(30127))
            return
        else:
            messageok(translate(30000),translate(30109))
            return
