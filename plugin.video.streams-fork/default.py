      ...
      if xbmc.getCondVisibility('System.Platform.Android'):
          ...
          if "aarch" in os.uname()[4]:
              ...
              if not os.path.isfile(os.path.join(fileslist,"acestream","chroot")):
                  ...
                  acestream_pack = "https://raw.githubusercontent.com/xngsrs/myhobby/master/acestream/acestream_arm%s.tar.gz" % arch 
              ...
              addon_log('arm')
              if not os.path.isfile(os.path.join(fileslist,"acestream","chroot")):
                  acestream_pack = "https://raw.githubusercontent.com/xngsrs/myhobby/master/acestream/acestream_arm32.tar.gz"
                  acekit(acestream_pack)
              import acestream as ace
              ace.acestreams_builtin(name,iconimage,url)
