...
from resources.core.sopparsers import sopparsers
from resources.core.resolver import go_to_id
from resources.core.history import *

def main_menu():
      addDir('[COLOR orange]SopCast RO [/COLOR]',MainURL,500,addonpath + art + 'web-parsers-menu.png',2,True)
      addDir('[COLOR orange]AceStreams [/COLOR]',MainURL,400,addonpath + art + 'web-parsers-menu.png',2,True)
...
elif mode == 500: sopparsers.addon_sopparsers_menu()
elif mode == 501:
	sopparsers.parser_check()
	package = 'resources.core.sopparsers.' + parser
	tree = "main"
	parser_module = getattr(__import__(package, fromlist=[tree]), tree)
	parser_module.module_tree(name,url,iconimage,mode,parser,parserfunction)
